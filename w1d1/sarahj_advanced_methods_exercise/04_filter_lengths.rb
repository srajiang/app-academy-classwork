...
# iteration required to eval each element
# run a comparison for length of each element
# set a default value for the second argument (5) [check]
# return array where the comparison returns true
